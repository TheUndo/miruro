...
import { getCurrentSeason, getNextSeason, year } from "../index";
...
export async function fetchAnimeData(animeId: string, provider = "gogoanime") {
...
export async function fetchAnimeInfo(animeId: string, provider = "gogoanime") {
	const params = new URLSearchParams({ provider });
